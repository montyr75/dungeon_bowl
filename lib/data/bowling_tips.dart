const bowlingTips = [
  ...
  "The 7-10 split, sometimes called bedposts or goalposts, occurs when only the 7 and 10 pins remain after a shot. Fun fact: The Greek Church is actually the hardest split to pick up.",
  ...
  "A full rack of pins has two pockets, the first between the 1 and 2 pins, and the second between the 1 and 3 pins. These are the optimal points of impact to achieve a strike.",
  ...
  "There are two versions of the Greek Church split: 4-6-7-9-10 and 4-6-7-8-10. Visually, these configurations are reminiscent of an old cathedral church with spires. This is world's hardest split to spare.",
